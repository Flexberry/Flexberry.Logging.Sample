  ...
  */
  init() {
    ...
    Ember.Logger.error = function() {
      ...
      _this._sendMessageToService(message, messageCategory.error, '');
    ...
    Ember.Logger.log = function() {
      ...
      _this._sendMessageToService(message, messageCategory.log, '');
    ...
    Ember.Logger.info = function() {
      ...
      _this._sendMessageToService(message, messageCategory.info, '');
    ...
    Ember.Logger.debug = function() {
      ...
      _this._sendMessageToService(message, messageCategory.debug, '');
